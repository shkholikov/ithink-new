...
export function generateStaticParams() {
  return [{ slug: "microsoft" }, { slug: "security" }, { slug: "design" }];
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: slug,
    alternates: {
      canonical: `https://ithink.uz/${locale}/licenses/${slug}`,
    },
  };
}
  ...
  return (
    <div className="pt-24 min-h-screen bg-background flex items-center justify-center">
      <div className="text-center">
        <p className="text-sm text-muted-foreground uppercase tracking-widest mb-3">Licenses</p>
