...
export function DottedMap<M extends Marker = Marker>({
  ...
  //
  // Upstream wraps this in React.useMemo, which would force the whole component
  // — and therefore any page rendering it — into the client bundle. Nothing
  // here is stateful or interactive (the pulse is SVG <animate>, not JS), and
  // the map renders once at build time, so a plain call keeps it a server
